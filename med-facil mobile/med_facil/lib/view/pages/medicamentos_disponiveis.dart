...
class MedicamentosDisponiveisPage extends StatefulWidget {
  ...
  @override
  State<MedicamentosDisponiveisPage> createState() => _MedicamentosDisponiveisPageState();
}

class _MedicamentosDisponiveisPageState extends State<MedicamentosDisponiveisPage> {
                ...
                onChanged: (text) {
                  ...
                  setState(() {
                    filteredMedicamento = medicamentos
                        .where((medicamento) => medicamento.nome.toLowerCase().contains(text.toLowerCase()))
                        .toList();
                  });
                },
  ...
  _launchPDF() async {
    const pdfURL = 'https://www.caceres.mt.gov.br/fotos_institucional_downloads/2.pdf'; // Substitua pelo URL do seu arquivo PDF
